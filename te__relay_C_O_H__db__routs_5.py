...
## SERVER_URL - used in 'def send_2_server()',  Refer row 894
# SERVER_URL = "http://192.168.2.101/FMuBruwer/3-fmubrewery-d2db-fem1.php"
# SERVER_URL = "http://192.168.2.101/FMuBruwer/3-fmubrewery-d2db-fem2.php"
# SERVER_URL = "http://192.168.2.103/FMuBruwer/3-fmubrewery-d2db-fem2.php"
SERVER_URL = "http://192.168.2.101/FMuBruwer/FMuBruwer-3.php"
# SERVER_URL = "http://192.168.2.105/FMuBruwer/FMuBruwer-3.php"
...
# from Fermenter_Settings import *
import settings
import sensors
import history
import control
...
def send_2_server_orr():

    text = "Communicating with Server"  # - 885"
    # Print the boxed text
    box_width = len(text) + 2  # Adding 2 to account for box borders
    print("waiting ....", end="")
    time.sleep(0.02)  # Delay for a short moment (10 milliseconds)
    ...
    print("waiting .....", end="")
    time.sleep(0.02)  # Delay for a short moment (10 milliseconds)
    #    print("\r┌ Server Response " + "─" * (line_length - 17) + "┐")
    print(
        "\r│  Server Response  "
        + " " * (line_length - 32)
        + "└"
...
def send_2_server():
    ...
    data = db_data  # Assuming db_data is a global or passed variable

    # Initialize response variables with defaults in case of failure
    Response_code = None
    ...
    try:
        ...
        print("Error sending data:", str(e))
        # Response_code and Response_cont already set to defaults
    ...
    save_clear_db.check_and_trigger_save()  # Assuming this is a local save mechanism
